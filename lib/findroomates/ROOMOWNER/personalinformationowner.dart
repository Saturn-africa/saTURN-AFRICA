...
class PERSinfoowner extends StatefulWidget {
  const PERSinfoowner({super.key});

  @override
  State<PERSinfoowner> createState() => _PERSinfoownerState();
}

class _PERSinfoownerState extends State<PERSinfoowner> {
                  ...
                  TextButton(
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: ((context) => Lifestyleowner(
                                      nextto: Roommate_pref(),
                                    ))));
                      },
                      child: Container(
