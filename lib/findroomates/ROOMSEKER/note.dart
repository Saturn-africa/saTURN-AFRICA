...
import 'package:saturn/findroomates/ROOMOWNER/personalinformationowner.dart';
...
class Noteowner extends StatefulWidget {
  const Noteowner({Key? key}) : super(key: key);

  @override
  State<Noteowner> createState() => _NoteownerState();
}

class _NoteownerState extends State<Noteowner> {
  @override
