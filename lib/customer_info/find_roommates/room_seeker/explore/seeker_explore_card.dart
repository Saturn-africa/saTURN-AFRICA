...
class SeekerExploreCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<SeekerRequestProvider>(
                          ...
                          child: Row(
                            children: [
                              ...
                              seeker.sexualInclinationOfRoommate == null
                                  ...
                                  : CustomCardContainer(
                                      text:
                                          seeker.sexualInclinationOfRoommate!),
                              seeker.religionOfRoommate == null &&
                                      seeker.ageRangeOfRoommate == null &&
                                      seeker.sexualInclinationOfRoommate == null
                                  ? Center(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: CustomButtonWidget(
                              onPressed: () async {
                                // print("seeker card id =====>>>> ${seeker.id}");
                                if (value.sendClicked) {
                                  value.onSendClick();
                                  return;
                                }
                                await value.seekerSendRequestMethod(
                                    context, seeker.id);
                              },
                              text: value.sendClicked
                                  ? loadingIndicator()
                                  : Text(
                                      "Send Request",
                                      style: ownerCardTitleStyle.copyWith(
