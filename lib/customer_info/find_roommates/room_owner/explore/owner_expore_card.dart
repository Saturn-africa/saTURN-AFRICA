...
class OwnerExploreCards extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<OwnerCardProvider>(
      builder: (_, card, __) {
        final request = context.read<OwnerRequestProvider>();
        final rewatch = context.watch<OwnerRequestProvider>();
                            ...
                            child: Row(
                              children: [
                                ...
                                owner.sexualInclinationOfRoommate == null
                                    ...
                                    : CustomCardContainer(
                                        text:
                                            owner.sexualInclinationOfRoommate!),
                                owner.religionOfRoommate == null &&
                                        owner.ageRangeOfRoommate == null &&
                                        owner.sexualInclinationOfRoommate ==
                                            null
                            ...
                            child: Row(
                              children: [
                                owner.apartmentLocation == null
                                    ...
                                    : CustomCardContainer(
                                        text:
                                            owner.apartmentLocation.toString()),
                                const SizedBox(width: 10),
                          ...
                          Expanded(
                            child: CustomButtonWidget(
                                onPressed: () async {
                                  ...
                                  await request.sendOwnerRequestMethod(
                                      context, owner.id ?? "0");
                                },
                                text: rewatch.requestClicked
                                    ? loadingIndicator()
                                    : Text(
                                        "Send Request",
                                        style: ownerCardTitleStyle.copyWith(
